		...
		<Dialog open={openDialog} maxWidth="lg" fullWidth onClose={() => setOpenDialog(false)} className="register-container">
			...
			<DialogContent dividers="true">
				<Stack spacing={1}>
					...
					<img className="register-container__img" src='https://n1-pstg.mioto.vn/cho_thue_xe_o_to_tu_lai_thue_xe_du_lich_hochiminh/suzuki_xl7_2021/p/g/2022/01/06/11/p8dimfuyKkuCDVTBJXllqA.jpg' ></img>
                    <Typography align="center" className="register-container__text">
						Ảnh mặt sau
					</Typography>
					<img className="register-container__img" src='https://n1-pstg.mioto.vn/cho_thue_xe_o_to_tu_lai_thue_xe_du_lich_hochiminh/suzuki_xl7_2021/p/g/2022/01/06/11/iot31_kGM2egPW8Y13plRg.jpg' ></img>
                    <Typography align="center" className="register-container__text">
						Ảnh bên trái
					</Typography>
					<img className="register-container__img" src='https://n1-pstg.mioto.vn/cho_thue_xe_o_to_tu_lai_thue_xe_du_lich_hochiminh/suzuki_xl7_2021/p/g/2022/01/06/11/ZqO0x5znjDiQmAXm-TZImA.jpg' ></img>
                    <Typography align="center" className="register-container__text">
						Ảnh bên phải
					</Typography>
					<img className="register-container__img" src='https://n1-pstg.mioto.vn/cho_thue_xe_o_to_tu_lai_thue_xe_du_lich_hochiminh/suzuki_xl7_2021/p/g/2022/01/06/11/Q4d90YuvqmySKM6antvEhA.jpg' ></img>
